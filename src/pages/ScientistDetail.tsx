            ...
            <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
                ...
                <div className="sticky top-0 z-50 bg-white dark:bg-gray-800 shadow-sm">
                    <div className="container mx-auto px-4 py-4 flex items-center">
                        ...
                        <h1 className="ml-4 text-xl font-bold text-gray-800 dark:text-white">科学家详情</h1>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-8">
                    <div
                        ...
                        <div className="relative bg-gradient-to-r from-red-700 to-red-500">
                            <div className="relative container mx-auto px-6 py-12 md:py-16">
                                <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
                                    <div
                                        className="w-32 h-32 md:w-40 md:h-40 rounded-full border-4 border-white dark:border-gray-700 bg-gray-300 dark:bg-gray-600 animate-pulse"></div>
                                    <div className="text-center md:text-left">
                                        <div
                                            className="h-8 md:h-10 w-48 md:w-64 bg-white/30 backdrop-blur-sm rounded-md animate-pulse mb-2"></div>
                                        <div
                                            className="h-4 w-32 bg-white/20 backdrop-blur-sm rounded-md animate-pulse mb-4"></div>
                                        <div className="flex flex-wrap justify-center md:justify-start gap-2">
                                            {[1, 2, 3].map(i => <div
                                                key={i}
                                                className="h-6 w-24 bg-white/20 backdrop-blur-sm rounded-full animate-pulse"></div>)}
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="p-6 md:p-8">
                            <div className="mb-8">
                                <div
                                    className="h-6 w-32 bg-gray-200 dark:bg-gray-700 rounded-md animate-pulse mb-4"></div>
                                <div className="space-y-2">
                                    <div
                                        className="h-4 w-full bg-gray-100 dark:bg-gray-700 rounded-md animate-pulse"></div>
                                    <div
                                        className="h-4 w-3/4 bg-gray-100 dark:bg-gray-700 rounded-md animate-pulse"></div>
                                    <div
                                        className="h-4 w-5/6 bg-gray-100 dark:bg-gray-700 rounded-md animate-pulse"></div>
                                </div>
                            </div>
                            <div>
                                <div
                                    className="h-6 w-32 bg-gray-200 dark:bg-gray-700 rounded-md animate-pulse mb-4"></div>
                                <div
                                    className="h-32 border border-dashed border-gray-300 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-900 animate-pulse"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div
                ...
                <div className="text-center">
                    <div
                        ...
                        <i
                            className="fas fa-exclamation-triangle text-red-500 dark:text-red-400 text-3xl"></i>
                    </div>
                    <h2 className="text-2xl font-bold text-red-600 dark:text-red-400">科学家不存在</h2>
                    <button
                        onClick={() => navigate("/")}
                        className="mt-4 px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg transition-colors">返回首页
                                  </button>
                </div>
            </div>
        );
            ...
            <motion.div
                ...
                <div
                    ...
                    <div className="relative">
                        <div
                            className="absolute inset-0 bg-gradient-to-r from-red-700 to-red-500 opacity-90"></div>
                        <div className="relative container mx-auto px-6 py-12 md:py-16">
                            <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
                                <motion.div
                                    initial={{
                    ...
                    <div className="p-6 md:p-8">
                        ...
                        <motion.div
                            ...
                            <h3
                                className="text-xl font-bold text-gray-800 dark:text-white mb-4 flex items-center">
                                <i className="fas fa-book text-red-600 dark:text-red-400 mr-2"></i>相关资料
                                              </h3>
                            {scientist.references.length > 0 ? <ul className="space-y-3">
                                {scientist.references.map((ref, index) => <li key={index}>
                                    <a
                                        href={ref}
                                        target="_blank"
                                ...
                                className="text-center py-8 border border-dashed border-gray-300 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-900/50">
                                <i
                                    className="fas fa-file-alt text-4xl text-gray-400 dark:text-gray-600 mb-3"></i>
                                <p className="text-gray-500 dark:text-gray-400">暂无相关资料</p>
                            </div>}
                        </motion.div>
                        ...
                        >
                            <h3 className="text-lg font-bold text-gray-800 dark:text-white mb-2">向科学家致敬</h3>
                            <p className="text-gray-600 dark:text-gray-400 mb-6 text-sm">点击下方按钮，为{scientist.name}院士献上一束花</p>
                            ...
                            >
                                <span className="text-4xl filter drop-shadow-sm group-hover:-translate-y-1 transition-transform">💐</span>
                                <span className="mt-1 text-xs font-bold text-red-600 dark:text-red-400">{tributeCount}</span>
